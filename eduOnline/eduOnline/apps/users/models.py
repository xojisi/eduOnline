...
class UserProfile(AbstractUser):
    ...
    mobile = models.CharField(max_length=12,null=True,blank=True, verbose_name=u'手机')
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(("register",u"注册"),("forget",u"找回密码"),("update_email","修改邮箱")),max_length=15,verbose_name=u"验证码类型")
    # 如果此处用datetime.now(),那么时间是该处实例化的时间!
